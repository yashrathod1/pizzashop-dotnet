...
$("#editSectionForm").submit(function (e) {
    ...
    console.log("Sending Category Data:", sectionData);
...
$(document).on("click", ".delete-section", function () {
    let sectionId = $(this).data("id");
    console.log("selected categoryId for delete:", sectionId)
...
$("#confirmDeleteBtnSection").click(function () {
    ...
    console.log("deleting category id", sectionId)
...
$(document).on("click", ".edit-table", function () {
    ...
    $.ajax({
        ...
        success: function (table) {
            ...
            console.log("table section id", table.sectionId);
